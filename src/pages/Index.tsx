      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-10 md:px-10 md:py-14">
        ...
        <main className="flex flex-1 flex-col gap-20 pb-10 md:gap-24 md:pb-16">
          ...
          <section id="hero" className="grid items-center gap-10 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1.2fr)]">
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="h-7 overflow-hidden text-sm font-medium uppercase tracking-[0.28em] text-primary">
                <span key={phraseIndex} className={`inline-block animate-fade-in ${isSwitching ? "opacity-0" : "opacity-100"}`}>
          ...
          <section id="about" className="space-y-4 opacity-0 animate-fade-in [animation-delay:120ms] [animation-fill-mode:forwards]">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground md:text-base">I build, refine, and maintain production-grade web experiences that prioritize reliability, performance, and long-term scalability. My work focuses on delivering fast, secure, and resilient systems. While ensuring that you dont break the bank</p>
